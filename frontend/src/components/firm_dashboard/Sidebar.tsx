...
const navigationItems = [
  ...
  },
  {
    ...
    path: "/firm-dashboard/lawyer/cases",
  },
  {
    id: "documents",
    label: "Documents",
    icon: <FileText className="h-5 w-5" />,
    path: "/firm-dashboard/lawyer/documents",
  },
  {
    id: "search",
    label: "Legal Search",
    icon: <Search className="h-5 w-5" />,
    path: "/firm-dashboard/lawyer/search",
  },
  {
    id: "clients",
    label: "Clients",
    icon: <Users className="h-5 w-5" />,
    path: "/firm-dashboard/lawyer/clients",
  },
  {
    id: "calendar",
    label: "Calendar",
    icon: <Calendar className="h-5 w-5" />,
    path: "/firm-dashboard/lawyer/calendar",
  },
  {
    id: "billing",
    label: "Billing",
    icon: <DollarSign className="h-5 w-5" />,
    path: "/firm-dashboard/lawyer/billing",
  },
  {
    id: "settings",
    label: "Settings",
    icon: <Settings className="h-5 w-5" />,
    path: "/firm-dashboard/lawyer/settings",
  },
];
